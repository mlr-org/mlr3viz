...
#'
#' Note that this function is a wrapper around [autoplot.ResampleResult()] for a temporary [mlr3::ResampleResult]
#' using [mlr3::mlr_resamplings_holdout] with ratio 1 (all observations in the training set).
#'
