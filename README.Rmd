...
The package draws plots with the [viridis](https://cran.r-project.org/web/packages/viridisLite/index.html) color palette and applies the [minimal theme](https://ggplot2.tidyverse.org/reference/ggtheme.html).
